"""Hindsight Experience Replay config for the 1D environment.
...
of the desired goal, matching OneDimVecEnv.compute_reward / is_terminal.
"""
...
def get_her_goals(trajectories, extras):
    ...
    new_goals = build_hindsight_goals(next_pos, lengths, mode=extras["mode"])  # (T, N, 1)
    ...
    # term flag refers to the real goal and is meaningless after relabeling.
