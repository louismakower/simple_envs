...
A point agent moves through the unit hypercube toward a randomly sampled goal, receiving a sparse reward on success. Two environments are provided:
...
Both environments support SAC and PPO, optionally with Hindsight Experience Replay (HER) and intrinsic motivation.
