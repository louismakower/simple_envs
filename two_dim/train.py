...
from two_dim import agents, config
...
def main():
    ...
    # Seed before constructing the env: TwoDimVecEnv.__init__ draws from np.random
    ...
    env = TwoDimVecEnv(num_envs=args.num_envs, max_episode_length=config.EPISODE_LENGTH, headless=args.headless)
